...
http_archive(
    ...
    sha256 = "1cd01be703cb0e46227d2da661b7ca5ae9f13b058c336fff01cb56338dba4488",
    strip_prefix = "protobuf-4.22.3",
    url = "https://github.com/protocolbuffers/protobuf/archive/refs/tags/v4.22.3.tar.gz",
)
